...
export const DEFAULT_PERMS = {
  dashboard:       { super_admin:2, it_admin:2, supervisor:1, region_manager:1, sales_rep:1, fridge_admin:0, viewer:1 },
  invoices:        { super_admin:2, it_admin:2, supervisor:1, region_manager:1, sales_rep:1, fridge_admin:0, viewer:1 },
  reports:         { super_admin:2, it_admin:2, supervisor:2, region_manager:2, sales_rep:2, fridge_admin:0, viewer:0 },
  customer_detail: { super_admin:2, it_admin:2, supervisor:1, region_manager:1, sales_rep:1, fridge_admin:0, viewer:1 },
  sales_activity:  { super_admin:2, it_admin:2, supervisor:1, region_manager:1, sales_rep:1, fridge_admin:0, viewer:0 },
  sales_tasks:     { super_admin:2, it_admin:2, supervisor:2, region_manager:2, sales_rep:2, fridge_admin:1, viewer:0 },
  fridges:         { super_admin:2, it_admin:2, supervisor:0, region_manager:1, sales_rep:0, fridge_admin:1, viewer:0 },
  stock:           { super_admin:2, it_admin:2, supervisor:0, region_manager:0, sales_rep:0, fridge_admin:0, viewer:0 },
  current_stock:   { super_admin:2, it_admin:2, supervisor:0, region_manager:0, sales_rep:0, fridge_admin:0, viewer:0 },
  upload:          { super_admin:2, it_admin:2, supervisor:0, region_manager:0, sales_rep:0, fridge_admin:0, viewer:0 },
  users:           { super_admin:2, it_admin:0, supervisor:0, region_manager:0, sales_rep:0, fridge_admin:0, viewer:0 },
  permissions:     { super_admin:2, it_admin:1, supervisor:0, region_manager:0, sales_rep:0, fridge_admin:0, viewer:0 },
};
